...
"         2024 Nov 05: support KWAI timestamps
...
syn match   messagesBegin       display '^' nextgroup=messagesDate,messagesDateKWAI
...
syn match   messagesDateKWAI    contained display '\d\{4}-\d\d-\d\d[ T]'
                                \ nextgroup=messagesHourKWAI

syn match   messagesHourKWAI    contained display '\d\d:\d\d:\d\d\.\d\{6}'
                                \ nextgroup=messagesHost

syn match   messagesDateRFC3339 contained display '\d\{4}-\d\d-\d\d\(\.\d\{6}\)\='
syn match   messagesRFC3339T    contained display '\cT'
                                \ nextgroup=messagesHourRFC3339

syn match   messagesHourRFC3339 contained display '\d\d:\d\d:\d\d\(\.\d\+\)\=\([+-]\d\d:\d\d\|Z\)'
...
hi def link messagesDateKWAI    Constant
hi def link messagesHourKWAI    Type
